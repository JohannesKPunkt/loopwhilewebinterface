		...
		return this.each(function()
		{
			...
			var terminal_command = function(e, first)
			{
		 		...
		 		if ("" != val || settings.allow_empty_input)
				{
	 			...
	 			post_vars["session_id"] = session_id;
				...
				function terminal_command_error(x, tStatus)
				{
					...
					switch(tStatus)
					{
						...
						default:
						case 'error':
							out+= 'A server error has occured.';
							break;
					}
			...
			window.global_terminal_command = terminal_command;
			window.global_terminal_append = terminal_append;
